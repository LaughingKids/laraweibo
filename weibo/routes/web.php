...
Route::get('/users/{user}/followings', 'Views\UsersController@followings')->name('users.followings');
Route::get('/users/{user}/followers', 'Views\UsersController@followers')->name('users.followers');
